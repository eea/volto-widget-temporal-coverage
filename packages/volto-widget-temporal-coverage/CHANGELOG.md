...
### [7.0.1](https://github.com/eea/volto-widget-temporal-coverage/compare/7.0.0...7.0.1) - 8 April 2026

#### :hammer_and_wrench: Others

- test: Fix make test [Alin V. (Claudiu) - [`0f48544`](https://github.com/eea/volto-widget-temporal-coverage/commit/0f485448baa92b4f685c30b227fa1438cacb63c1)]
## [7.0.0](https://github.com/eea/volto-widget-temporal-coverage/compare/6.0.0...7.0.0) - 25 March 2026

#### :rocket: New Features

- feat: Volto 18 support - refs #287700 [Alin Voinea - [`b444cf8`](https://github.com/eea/volto-widget-temporal-coverage/commit/b444cf87856ca0cd5f71c5b13c3dabd1d938563d)]

#### :house: Internal changes

- chore: [JENKINSFILE] add package version in sonarqube [valentinab25 - [`da904f2`](https://github.com/eea/volto-widget-temporal-coverage/commit/da904f2dfd3a22077d0cbc6d36e4a3017faf9bea)]
- chore: [JENKINSFILE] use sonarqube branches [EEA Jenkins - [`c2d1636`](https://github.com/eea/volto-widget-temporal-coverage/commit/c2d1636188ef8e889e04fb23ebc5b11879508d1e)]

#### :hammer_and_wrench: Others

- tests: Fix Sonar Qube tags - refs #297339 [Alin Voinea - [`2173bc3`](https://github.com/eea/volto-widget-temporal-coverage/commit/2173bc39cdd6ff1b8d9c9b18610bcebd64267111)]
- Add Sonarqube tag using clms-frontend addons list [EEA Jenkins - [`523acdf`](https://github.com/eea/volto-widget-temporal-coverage/commit/523acdf1b59d4ca05d216811f34f188252a2adba)]
- Add Sonarqube tag using clms-frontend addons list [EEA Jenkins - [`9a85af0`](https://github.com/eea/volto-widget-temporal-coverage/commit/9a85af0b16fa14aad6c86c0fd18c3d6a266a3160)]
- Add Sonarqube tag using eea-website-frontend addons list [EEA Jenkins - [`2841c92`](https://github.com/eea/volto-widget-temporal-coverage/commit/2841c9247644cbe9922599b37b00096d8999c33a)]
- Add Sonarqube tag using eea-website-frontend addons list [EEA Jenkins - [`0040c24`](https://github.com/eea/volto-widget-temporal-coverage/commit/0040c247c1999952e35632cde0f164083315ec07)]
- Add Sonarqube tag using clms-frontend addons list [EEA Jenkins - [`8c78866`](https://github.com/eea/volto-widget-temporal-coverage/commit/8c788668cd8fccc22a5349defd9d5899043d3eca)]
- Add Sonarqube tag using ied-frontend addons list [EEA Jenkins - [`f7adaa4`](https://github.com/eea/volto-widget-temporal-coverage/commit/f7adaa4c57d0e43d3c94b880cf271214a80b4ec2)]
## [6.0.0](https://github.com/eea/volto-widget-temporal-coverage/compare/5.2.0...6.0.0) - 22 April 2024
...
- Add Sonarqube tag using insitu-frontend addons list [EEA Jenkins - [`d57b39a`](https://github.com/eea/volto-widget-temporal-coverage/commit/d57b39ae36b2d3d08128b34b844562543956dec3)]
- Add Sonarqube tag using freshwater-frontend addons list [EEA Jenkins - [`9fc535c`](https://github.com/eea/volto-widget-temporal-coverage/commit/9fc535c4b429129db3d8e55ed81707decddbc2bf)]
- Add Sonarqube tag using insitu-frontend addons list [EEA Jenkins - [`d11807d`](https://github.com/eea/volto-widget-temporal-coverage/commit/d11807dad7f1365f47aa0fc1bb5d074aa289d4bf)]
...
- chore: [JENKINS] Refactor automated testing [valentinab25 - [`2e4587c`](https://github.com/eea/volto-widget-temporal-coverage/commit/2e4587c4396c6f85778a77eca54c793d408f13f8)]
...
- test: [JENKINS] Use java17 for sonarqube scanner [valentinab25 - [`4d34465`](https://github.com/eea/volto-widget-temporal-coverage/commit/4d34465b713d92b2edc4b67f32f0a59ecf0c9fb6)]
- test: [JENKINS] Run cypress in started frontend container [valentinab25 - [`b708035`](https://github.com/eea/volto-widget-temporal-coverage/commit/b70803592da7e61f5cb0d47c7d6085c535d7b458)]
- test: [JENKINS] Add cpu limit on cypress docker [valentinab25 - [`cdf2cf9`](https://github.com/eea/volto-widget-temporal-coverage/commit/cdf2cf988f51a054a5b3bf359f339233c09546f3)]
- test: [JENKINS] Increase shm-size to cypress docker [valentinab25 - [`a81253a`](https://github.com/eea/volto-widget-temporal-coverage/commit/a81253a39e2b0f36061f0ceae9161e88a2fdf994)]
- test: [JENKINS] Improve cypress time [valentinab25 - [`9007176`](https://github.com/eea/volto-widget-temporal-coverage/commit/90071764941653623d8728c054966724372a89a5)]
...
- test: Fix eslint and yarn i18n [Alin Voinea - [`3a7ac5d`](https://github.com/eea/volto-widget-temporal-coverage/commit/3a7ac5d534ec3ddeb0df9ee09eb124f10d9d553d)]
- test: Fix eslint and yarn i18n [Alin Voinea - [`c061cd8`](https://github.com/eea/volto-widget-temporal-coverage/commit/c061cd896e5f09b28d07aad22d0aebe50c783908)]
